        ...
        >
          ...
          <div className='aboutTopCard'>
            ...
            <p className='para-1'>
              ...
              services may exceed the total value of products as a percentage of
              GDP.
            </p>
          </div>
        </FlexCol>
            ...
            <ServiceInfoBody>
              <ServicesInfo>
                <FlexCol size='2' style={{ maxWidth: '45%' }}>
                  The Resume Screening round is the first and most critical step
                  in getting your application to the next level.
                  <br />
                  <br />
                  What you can expect from us:
                  <br />
                  - Your resume will be written by a team of seasoned experts
                  <br />
                  - They will make sure that your Resume presents yourstrong
                  points, achievements & key skills in a recruiter-friendly
                  format.
                  <br />
                </FlexCol>
                <FlexCol
